...
public class TurnOrStrafeAndDistancePhotonObj extends ProfiledDoublePIDCommand {
  ...
  // constructor
  public TurnOrStrafeAndDistancePhotonObj(double targetDistance, PhotonObjects photon, DriveSubsystem drive) {
    super(
        m_PID1, m_PID2,
