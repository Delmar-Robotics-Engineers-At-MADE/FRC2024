...
public class DriveSubsystem extends SubsystemBase {
  ...
  PhotonObjects m_photonObj;
  PhotonApril m_photonApril;
  ...
  public DriveSubsystem(PhotonObjects photonObj, PhotonApril photonApril) {
    m_photonObj = photonObj;
    m_photonApril = photonApril;
  ...
  public Command getDriveStraightCommand(double distance) {
    ...
    MecanumControllerCommand mecanumControllerCommand =
        new MecanumControllerCommand(
            ...
            this::getCurrentWheelSpeeds,
            this::setDriveMotorControllersVolts, // Consumer for the output motor voltages
            this);
